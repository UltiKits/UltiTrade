...
import com.ultikits.plugins.trade.i18n.UltiTradeLanguageCatalogueTest.Catalogue;
 ...
 * ({@link UltiTradeLanguageCatalogueTest#loadModuleCatalogues()}: the framework's own {@link Language},
...
public final class CatalogueText {
    ...
    public static Map<String, String> entries(String code) {
        try {
            for (Catalogue c : UltiTradeLanguageCatalogueTest.loadModuleCatalogues()) {
